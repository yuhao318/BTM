...
class Places_LT(object):
    def __init__(self, distributed, root="", batch_size=60, num_works=40):
        ...
        bl_train_txt = "./datasets/data_txt/Places_BL_train.txt"

        bl_train_5_0_txt = "./datasets/data_txt/Places_BL_train_5_0.txt"
        bl_train_5_1_txt = "./datasets/data_txt/Places_BL_train_5_1.txt"
        bl_train_5_2_txt = "./datasets/data_txt/Places_BL_train_5_2.txt"
        bl_train_5_3_txt = "./datasets/data_txt/Places_BL_train_5_3.txt"
        bl_train_5_4_txt = "./datasets/data_txt/Places_BL_train_5_4.txt"
        bl_train_5_5_txt = "./datasets/data_txt/Places_BL_train_5_5.txt"
        bl_train_5_6_txt = "./datasets/data_txt/Places_BL_train_5_6.txt"
        bl_train_5_7_txt = "./datasets/data_txt/Places_BL_train_5_7.txt"
        bl_train_5_8_txt = "./datasets/data_txt/Places_BL_train_5_8.txt"
        bl_train_5_9_txt = "./datasets/data_txt/Places_BL_train_5_9.txt"

        bl_train_5_0_1_txt = "./datasets/data_txt/Places_BL_train_5_0_1.txt"

        bl_train_10_0_txt = "./datasets/data_txt/Places_BL_train_10_0.txt"
        bl_train_10_1_txt = "./datasets/data_txt/Places_BL_train_10_1.txt"
        bl_train_10_2_txt = "./datasets/data_txt/Places_BL_train_10_2.txt"
        bl_train_10_3_txt = "./datasets/data_txt/Places_BL_train_10_3.txt"
        bl_train_10_4_txt = "./datasets/data_txt/Places_BL_train_10_4.txt"
        bl_train_10_5_txt = "./datasets/data_txt/Places_BL_train_10_5.txt"
        bl_train_10_6_txt = "./datasets/data_txt/Places_BL_train_10_6.txt"
        bl_train_10_7_txt = "./datasets/data_txt/Places_BL_train_10_7.txt"
        bl_train_10_8_txt = "./datasets/data_txt/Places_BL_train_10_8.txt"
        bl_train_10_9_txt = "./datasets/data_txt/Places_BL_train_10_9.txt"

    
        bl_train_5_10_txt = "./datasets/data_txt/Places_BL_train_5_10.txt"
        bl_train_5_11_txt = "./datasets/data_txt/Places_BL_train_5_11.txt"
        bl_train_5_12_txt = "./datasets/data_txt/Places_BL_train_5_12.txt"
        bl_train_5_13_txt = "./datasets/data_txt/Places_BL_train_5_13.txt"
        bl_train_5_14_txt = "./datasets/data_txt/Places_BL_train_5_14.txt"
        bl_train_5_15_txt = "./datasets/data_txt/Places_BL_train_5_15.txt"
        bl_train_5_16_txt = "./datasets/data_txt/Places_BL_train_5_16.txt"
        bl_train_5_17_txt = "./datasets/data_txt/Places_BL_train_5_17.txt"
        bl_train_5_18_txt = "./datasets/data_txt/Places_BL_train_5_18.txt"
        bl_train_5_19_txt = "./datasets/data_txt/Places_BL_train_5_19.txt"
        ...
        eval_train_dataset = LT_Dataset_Eval(root, train_txt, transform=transform_test, class_map=train_dataset.class_map)

        bl_train_dataset = BL_Dataset(root, bl_train_txt, transform=transform_train, class_map=train_dataset.class_map)
        eval_bl_train_dataset = LT_Dataset_Eval(root, bl_train_txt, transform=transform_test, class_map=train_dataset.class_map)
        ...
        bl_train_5_0_1_dataset = BL_Dataset(root, bl_train_5_0_1_txt, transform=transform_train, class_map=train_dataset.class_map)
        eval_bl_train_5_0_1_dataset = LT_Dataset_Eval(root, bl_train_5_0_1_txt, transform=transform_test, class_map=train_dataset.class_map)
        ...
        self.eval_train = torch.utils.data.DataLoader(
            eval_train_dataset,
            batch_size=batch_size, shuffle=False,
            num_workers=num_works, pin_memory=True)

        self.bl_dist_sampler = torch.utils.data.distributed.DistributedSampler(bl_train_dataset) if distributed else None
        self.bl_train_instance = torch.utils.data.DataLoader(
            bl_train_dataset,
            batch_size=batch_size, shuffle=True,
            num_workers=num_works, pin_memory=True, sampler=self.bl_dist_sampler)

        bl_balance_sampler = ClassAwareSampler(bl_train_dataset)
        self.bl_train_balance = torch.utils.data.DataLoader(
            bl_train_dataset,
            batch_size=batch_size, shuffle=False,
            num_workers=num_works, pin_memory=True, sampler=bl_balance_sampler)

        self.eval_bl = torch.utils.data.DataLoader(
            eval_bl_train_dataset,
            batch_size=batch_size, shuffle=False,
            num_workers=num_works, pin_memory=True)
        ...
        self.bl_train_5_0_1_dist_sampler = torch.utils.data.distributed.DistributedSampler(bl_train_5_0_1_dataset) if distributed else None
        self.bl_train_5_0_1_instance = torch.utils.data.DataLoader(
            bl_train_5_0_1_dataset,
            batch_size=batch_size, shuffle=True,
            num_workers=num_works, pin_memory=True, sampler=self.bl_train_5_0_1_dist_sampler)

        bl_train_5_0_1_balance_sampler = ClassAwareSampler(bl_train_5_0_1_dataset)
        self.bl_train_5_0_1_balance = torch.utils.data.DataLoader(
            bl_train_5_0_1_dataset,
            batch_size=batch_size, shuffle=False,
            num_workers=num_works, pin_memory=True, sampler=bl_train_5_0_1_balance_sampler)
        ...
        bl_train_5_10_dataset = BL_Dataset(root, bl_train_5_10_txt, transform=transform_train, class_map=train_dataset.class_map)
        eval_bl_train_5_10_dataset = LT_Dataset_Eval(root, bl_train_5_10_txt, transform=transform_test, class_map=train_dataset.class_map)

        bl_train_5_11_dataset = BL_Dataset(root, bl_train_5_11_txt, transform=transform_train, class_map=train_dataset.class_map)
        eval_bl_train_5_11_dataset = LT_Dataset_Eval(root, bl_train_5_11_txt, transform=transform_test, class_map=train_dataset.class_map)

        bl_train_5_12_dataset = BL_Dataset(root, bl_train_5_12_txt, transform=transform_train, class_map=train_dataset.class_map)
        eval_bl_train_5_12_dataset = LT_Dataset_Eval(root, bl_train_5_12_txt, transform=transform_test, class_map=train_dataset.class_map)

        bl_train_5_13_dataset = BL_Dataset(root, bl_train_5_13_txt, transform=transform_train, class_map=train_dataset.class_map)
        eval_bl_train_5_13_dataset = LT_Dataset_Eval(root, bl_train_5_13_txt, transform=transform_test, class_map=train_dataset.class_map)

        bl_train_5_14_dataset = BL_Dataset(root, bl_train_5_14_txt, transform=transform_train, class_map=train_dataset.class_map)
        eval_bl_train_5_14_dataset = LT_Dataset_Eval(root, bl_train_5_14_txt, transform=transform_test, class_map=train_dataset.class_map)

        bl_train_5_15_dataset = BL_Dataset(root, bl_train_5_15_txt, transform=transform_train, class_map=train_dataset.class_map)
        eval_bl_train_5_15_dataset = LT_Dataset_Eval(root, bl_train_5_15_txt, transform=transform_test, class_map=train_dataset.class_map)

        bl_train_5_16_dataset = BL_Dataset(root, bl_train_5_16_txt, transform=transform_train, class_map=train_dataset.class_map)
        eval_bl_train_5_16_dataset = LT_Dataset_Eval(root, bl_train_5_16_txt, transform=transform_test, class_map=train_dataset.class_map)

        bl_train_5_17_dataset = BL_Dataset(root, bl_train_5_17_txt, transform=transform_train, class_map=train_dataset.class_map)
        eval_bl_train_5_17_dataset = LT_Dataset_Eval(root, bl_train_5_17_txt, transform=transform_test, class_map=train_dataset.class_map)

        bl_train_5_18_dataset = BL_Dataset(root, bl_train_5_18_txt, transform=transform_train, class_map=train_dataset.class_map)
        eval_bl_train_5_18_dataset = LT_Dataset_Eval(root, bl_train_5_18_txt, transform=transform_test, class_map=train_dataset.class_map)

        bl_train_5_19_dataset = BL_Dataset(root, bl_train_5_19_txt, transform=transform_train, class_map=train_dataset.class_map)
        eval_bl_train_5_19_dataset = LT_Dataset_Eval(root, bl_train_5_19_txt, transform=transform_test, class_map=train_dataset.class_map)


        self.bl_train_5_10_dist_sampler = torch.utils.data.distributed.DistributedSampler(bl_train_5_10_dataset) if distributed else None
        self.bl_train_5_10_instance = torch.utils.data.DataLoader(
            bl_train_5_10_dataset,
            batch_size=batch_size, shuffle=True,
            num_workers=num_works, pin_memory=True, sampler=self.bl_train_5_10_dist_sampler)

        bl_train_5_10_balance_sampler = ClassAwareSampler(bl_train_5_10_dataset)
        self.bl_train_5_10_balance = torch.utils.data.DataLoader(
            bl_train_5_10_dataset,
            batch_size=batch_size, shuffle=False,
            num_workers=num_works, pin_memory=True, sampler=bl_train_5_10_balance_sampler)

        self.bl_train_5_11_dist_sampler = torch.utils.data.distributed.DistributedSampler(bl_train_5_11_dataset) if distributed else None
        self.bl_train_5_11_instance = torch.utils.data.DataLoader(
            bl_train_5_11_dataset,
            batch_size=batch_size, shuffle=True,
            num_workers=num_works, pin_memory=True, sampler=self.bl_train_5_11_dist_sampler)

        bl_train_5_11_balance_sampler = ClassAwareSampler(bl_train_5_11_dataset)
        self.bl_train_5_11_balance = torch.utils.data.DataLoader(
            bl_train_5_11_dataset,
            batch_size=batch_size, shuffle=False,
            num_workers=num_works, pin_memory=True, sampler=bl_train_5_11_balance_sampler)

        self.bl_train_5_12_dist_sampler = torch.utils.data.distributed.DistributedSampler(bl_train_5_12_dataset) if distributed else None
        self.bl_train_5_12_instance = torch.utils.data.DataLoader(
            bl_train_5_12_dataset,
            batch_size=batch_size, shuffle=True,
            num_workers=num_works, pin_memory=True, sampler=self.bl_train_5_12_dist_sampler)

        bl_train_5_12_balance_sampler = ClassAwareSampler(bl_train_5_12_dataset)
        self.bl_train_5_12_balance = torch.utils.data.DataLoader(
            bl_train_5_12_dataset,
            batch_size=batch_size, shuffle=False,
            num_workers=num_works, pin_memory=True, sampler=bl_train_5_12_balance_sampler)

        self.bl_train_5_13_dist_sampler = torch.utils.data.distributed.DistributedSampler(bl_train_5_13_dataset) if distributed else None
        self.bl_train_5_13_instance = torch.utils.data.DataLoader(
            bl_train_5_13_dataset,
            batch_size=batch_size, shuffle=True,
            num_workers=num_works, pin_memory=True, sampler=self.bl_train_5_13_dist_sampler)

        bl_train_5_13_balance_sampler = ClassAwareSampler(bl_train_5_13_dataset)
        self.bl_train_5_13_balance = torch.utils.data.DataLoader(
            bl_train_5_13_dataset,
            batch_size=batch_size, shuffle=False,
            num_workers=num_works, pin_memory=True, sampler=bl_train_5_13_balance_sampler)

        self.bl_train_5_14_dist_sampler = torch.utils.data.distributed.DistributedSampler(bl_train_5_14_dataset) if distributed else None
        self.bl_train_5_14_instance = torch.utils.data.DataLoader(
            bl_train_5_14_dataset,
            batch_size=batch_size, shuffle=True,
            num_workers=num_works, pin_memory=True, sampler=self.bl_train_5_14_dist_sampler)

        bl_train_5_14_balance_sampler = ClassAwareSampler(bl_train_5_14_dataset)
        self.bl_train_5_14_balance = torch.utils.data.DataLoader(
            bl_train_5_14_dataset,
            batch_size=batch_size, shuffle=False,
            num_workers=num_works, pin_memory=True, sampler=bl_train_5_14_balance_sampler)

        self.bl_train_5_15_dist_sampler = torch.utils.data.distributed.DistributedSampler(bl_train_5_15_dataset) if distributed else None
        self.bl_train_5_15_instance = torch.utils.data.DataLoader(
            bl_train_5_15_dataset,
            batch_size=batch_size, shuffle=True,
            num_workers=num_works, pin_memory=True, sampler=self.bl_train_5_15_dist_sampler)

        bl_train_5_15_balance_sampler = ClassAwareSampler(bl_train_5_15_dataset)
        self.bl_train_5_15_balance = torch.utils.data.DataLoader(
            bl_train_5_15_dataset,
            batch_size=batch_size, shuffle=False,
            num_workers=num_works, pin_memory=True, sampler=bl_train_5_15_balance_sampler)

        self.bl_train_5_16_dist_sampler = torch.utils.data.distributed.DistributedSampler(bl_train_5_16_dataset) if distributed else None
        self.bl_train_5_16_instance = torch.utils.data.DataLoader(
            bl_train_5_16_dataset,
            batch_size=batch_size, shuffle=True,
            num_workers=num_works, pin_memory=True, sampler=self.bl_train_5_16_dist_sampler)

        bl_train_5_16_balance_sampler = ClassAwareSampler(bl_train_5_16_dataset)
        self.bl_train_5_16_balance = torch.utils.data.DataLoader(
            bl_train_5_16_dataset,
            batch_size=batch_size, shuffle=False,
            num_workers=num_works, pin_memory=True, sampler=bl_train_5_16_balance_sampler)

        self.bl_train_5_17_dist_sampler = torch.utils.data.distributed.DistributedSampler(bl_train_5_17_dataset) if distributed else None
        self.bl_train_5_17_instance = torch.utils.data.DataLoader(
            bl_train_5_17_dataset,
            batch_size=batch_size, shuffle=True,
            num_workers=num_works, pin_memory=True, sampler=self.bl_train_5_17_dist_sampler)

        bl_train_5_17_balance_sampler = ClassAwareSampler(bl_train_5_17_dataset)
        self.bl_train_5_17_balance = torch.utils.data.DataLoader(
            bl_train_5_17_dataset,
            batch_size=batch_size, shuffle=False,
            num_workers=num_works, pin_memory=True, sampler=bl_train_5_17_balance_sampler)

        self.bl_train_5_18_dist_sampler = torch.utils.data.distributed.DistributedSampler(bl_train_5_18_dataset) if distributed else None
        self.bl_train_5_18_instance = torch.utils.data.DataLoader(
            bl_train_5_18_dataset,
            batch_size=batch_size, shuffle=True,
            num_workers=num_works, pin_memory=True, sampler=self.bl_train_5_18_dist_sampler)

        bl_train_5_18_balance_sampler = ClassAwareSampler(bl_train_5_18_dataset)
        self.bl_train_5_18_balance = torch.utils.data.DataLoader(
            bl_train_5_18_dataset,
            batch_size=batch_size, shuffle=False,
            num_workers=num_works, pin_memory=True, sampler=bl_train_5_18_balance_sampler)

        self.bl_train_5_19_dist_sampler = torch.utils.data.distributed.DistributedSampler(bl_train_5_19_dataset) if distributed else None
        self.bl_train_5_19_instance = torch.utils.data.DataLoader(
            bl_train_5_19_dataset,
            batch_size=batch_size, shuffle=True,
            num_workers=num_works, pin_memory=True, sampler=self.bl_train_5_19_dist_sampler)

        bl_train_5_19_balance_sampler = ClassAwareSampler(bl_train_5_19_dataset)
        self.bl_train_5_19_balance = torch.utils.data.DataLoader(
            bl_train_5_19_dataset,
            batch_size=batch_size, shuffle=False,
            num_workers=num_works, pin_memory=True, sampler=bl_train_5_19_balance_sampler)
